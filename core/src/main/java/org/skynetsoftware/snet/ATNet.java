...
public class ATNet extends AsyncTask<Void, Void, ResponseParser>
{
    ...
    private org.skynetsoftware.snet.NoInternetConnectionHandler noInternetConnectionHandler;
    ...
    {
        if(!SNet.getInstance().getNetwork().isNetworkAvailable())//if we don't have internet connection prevent task from starting and notify user
        {
    ...
    public void setNoInternetConnectionHandler(org.skynetsoftware.snet.NoInternetConnectionHandler noInternetConnectionHandler)
    {
