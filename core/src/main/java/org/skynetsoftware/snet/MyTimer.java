...
{
    public final String LOG_TAG = SNet.LOG_TAG + ":" + getClass().getSimpleName();
    ...
    {
        if(SNet.LOGGING) Log.d(LOG_TAG, message + get());
    }

    public void logAvg(String message)
    {
        if(SNet.LOGGING) Log.d(LOG_TAG, message + avg());
    }

    public void logTotal(String message)
    {
        if(SNet.LOGGING) Log.d(LOG_TAG, message + total());
    }
