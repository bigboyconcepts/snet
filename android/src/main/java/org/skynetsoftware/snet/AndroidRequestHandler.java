...
public class AndroidRequestHandler implements RequestHandler
{
    ...
    @Override
    public ResponseParser handleRequest(int requestCode, @NonNull Request request, boolean sync)
    {
        Internet.Response response = SNet.getInstance().getInternet().executeHttpRequest(request);
